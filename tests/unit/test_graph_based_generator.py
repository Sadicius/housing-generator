...
def test_rooms_are_grouped_by_zone_in_separate_horizontal_strips():
    ...
    assert (
        living.boundary.polygon.bounds[1] != bed.boundary.polygon.bounds[1]
        or living.boundary.polygon.bounds[0] != bed.boundary.polygon.bounds[0]
    )
    assert (
        living.boundary.polygon.bounds[1] != bath.boundary.polygon.bounds[1]
        or living.boundary.polygon.bounds[0] != bath.boundary.polygon.bounds[0]
    )
