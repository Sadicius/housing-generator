...
def test_wet_core_with_only_two_wet_rooms_still_requires_distance_one():
    ...
    kitchen = _placed_room("kitchen", RoomType.KITCHEN, box(0, 0, 3, 3))
    bathroom = _placed_room("bathroom", RoomType.BATHROOM, box(4, 0, 7, 3))  # NO toca cocina (hueco de 1m)
...
def test_wet_core_with_three_wet_rooms_allows_distance_two():
    ...
    laundry = _placed_room("laundry", RoomType.LAUNDRY, box(6, 0, 9, 3))    # toca bano, cocina a distancia 2
...
def test_wet_core_with_three_wet_rooms_still_fails_beyond_distance_two():
    kitchen = _placed_room("kitchen", RoomType.KITCHEN, box(0, 0, 3, 3))
    bathroom = _placed_room("bathroom", RoomType.BATHROOM, box(3, 0, 6, 3))    # toca cocina, distancia 1
    hall = _placed_room("hall", RoomType.ENTRANCE_HALL, box(6, 0, 9, 3))       # entre bano y lavadero, no humeda
    laundry = _placed_room("laundry", RoomType.LAUNDRY, box(9, 0, 12, 3))      # toca hall, cocina a distancia 3

    layout = Layout(lot=_dummy_lot(), rooms=[kitchen, bathroom, hall, laundry], zones=[])
