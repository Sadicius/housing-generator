...
def test_room_gets_default_zone_from_type():
    room = Room(id="bed1", name="Dormitorio", room_type=RoomType.BEDROOM, dimensions=Dimensions(area_m2=12))
...
def test_kitchen_bathroom_laundry_are_wet_by_default():
    kitchen = Room(id="k", name="Cocina", room_type=RoomType.KITCHEN, dimensions=Dimensions(area_m2=10))
    bathroom = Room(id="b", name="Bano", room_type=RoomType.BATHROOM, dimensions=Dimensions(area_m2=5))
    laundry = Room(id="l", name="Lavadero", room_type=RoomType.LAUNDRY, dimensions=Dimensions(area_m2=5))
...
def test_living_room_and_bedroom_are_not_wet_by_default():
    living = Room(id="li", name="Estar", room_type=RoomType.LIVING_ROOM, dimensions=Dimensions(area_m2=20))
    bedroom = Room(id="be", name="Dorm", room_type=RoomType.BEDROOM, dimensions=Dimensions(area_m2=12))
...
def test_corridor_and_entrance_hall_default_to_circulation_zone_not_day():
    ...
    hall = Room(id="h", name="Vestibulo", room_type=RoomType.ENTRANCE_HALL, dimensions=Dimensions(area_m2=4))
