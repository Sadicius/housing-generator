...
def test_rectangle_gets_exact_bounds_from_different_retranqueo_per_side():
    ...
    resultado = retranqueo_variable_por_lado(cuadrado, {"south": 5, "north": 1, "east": 2, "west": 3})
...
def test_excessive_retranqueo_collapses_to_empty_polygon_not_a_crash():
    ...
    resultado = retranqueo_variable_por_lado(cuadrado, {"south": 8, "north": 8}, retranqueo_default_m=0.0)
...
def test_real_irregular_parcel_produces_a_valid_smaller_polygon():
    ...
    resultado = retranqueo_variable_por_lado(poligono_real, {"south": 5}, retranqueo_default_m=1.0)
...
def test_asymmetric_retranqueo_on_real_parcel_reduces_more_than_uniform_minimum():
    ...
    con_asimetria = retranqueo_variable_por_lado(poligono_real, {"south": 5}, retranqueo_default_m=1.0)
    todo_uniforme_bajo = retranqueo_variable_por_lado(poligono_real, {}, retranqueo_default_m=1.0)
