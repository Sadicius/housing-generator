...
DEFAULT_TYPE_ADJACENCY: Dict[Tuple[RoomType, RoomType], AdjacencyStrength] = {
    ...
    (RoomType.LAUNDRY, RoomType.DRYING_AREA): AdjacencyStrength.SHOULD_BE_NEAR,
    ...
    (RoomType.LIVING_ROOM, RoomType.ENTRANCE_HALL): AdjacencyStrength.SHOULD_BE_NEAR,
    (RoomType.LIVING_ROOM, RoomType.GARAGE): AdjacencyStrength.SHOULD_BE_AWAY,
